...
{
    public Review(Guid id, Guid vehiculoId, Guid alquilerId, Guid userId, Rating rating, Comentario comentario, DateTime fechaCreacion) : base(id)
    {
    ...
    public static Result<Review> Create(Alquiler alquiler, Rating rating, Comentario comentario, DateTime fechaCreacion)
    {
        ...
        {
            return Result.Failure<Review>(ReviewErrors.NotEligibleForReview);
        }
